...
# ay=north_money_flow()#历年北上资金流入情况，可分别选沪，深等
# ay.to_csv('northMoneyFlow.csv',encoding='utf-8-sig')
###
# az=north_money_stock()
###
# az.to_csv('northMoney.csv',encoding='utf-8-sig')